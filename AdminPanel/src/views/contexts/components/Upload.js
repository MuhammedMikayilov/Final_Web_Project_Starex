...
const UploadForm = (props)=> {
    const {titleRef, imageRef, itemId, state, setState, setModel, page} = props;

    const [image, uploadImg] = React.useState(itemId.image)
    const [photo, uploadPhoto] = React.useState();
    const [editorVal, updateEditorVal] = React.useState(itemId.title)
        ...
        <>
            {page.page !== 'intro'? (<>
                <div className="form-group">
                    ...
                    <input ref={titleRef} defaultValue={itemId.title} type="text" className="form-control"
