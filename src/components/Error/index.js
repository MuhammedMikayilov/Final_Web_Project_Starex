...
export const Error = React.memo(({ icon, message, ...props }) => {
  return (
    <div
      className="d-flex flex-column text-center align-items-center justify-content-center text-muted h-100"
      {...props}
    >
      {icon}
      <div className="fs-18">{message}</div>
