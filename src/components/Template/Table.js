...
export const Table = ({
  ...
  return (
    <div className="row">
      <div className="col-12 owerflow-x-scroll">
      ...
      <div className="col-md-4 d-flex justify-content-md-start justify-content-center align-items-center">
        {showLimitSelect()}
        {showRecord()}
      </div>
      <div className="col-md-4 offset-md-4 d-flex justify-content-md-end justify-content-center align-items-center mt-3 mt-md-0">
