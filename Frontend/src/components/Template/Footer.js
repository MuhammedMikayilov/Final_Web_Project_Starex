  ...
  return (
    <footer className="frame-header">
      <div style={{ background: "#3a3a3a" }} className="row h-100 m-0 p-5">
        <div className="col-12 row align-items-center">
          ...
          <div className="col-md-3 d-none d-md-block">
            <ul>{renderFooterFirst(4)}</ul>
          </div>
          <div className="col-md-3 d-none d-md-block">
            <ul>{renderFooterSecond(4)}</ul>
          </div>
          <div className="col-md-3 text-md-left text-center">
            <ul className="store-apps">
              <li className="mb-3">
                <a
                  href="https://apps.apple.com/az/app/starex-kargo/id1459518540"
                  target="_blank"
                >
                  <img
                    className="img-fluid"
              ...
              <li>
                <a
                  href="https://play.google.com/store/apps/details?id=pro.appify.starex&hl=en"
                  target="_blank"
                >
                  <img
                    className="img-fluid"
                    src={process.env.PUBLIC_URL + "./images/playMarket.png"}
                    alt=""
                  />
                </a>
              </li>
      ...
      <div className="row px-5 py-3 footer-bottom">
        <div className="col-md-6 text-md-start text-center mb-3">
          © 2020 Starex MMC | Bütün Hüquqlar Qorunur
        </div>
